...
// app.use(express.static(path.join(__dirname, '../mini-crm-frontend/build')));
...
//         console.log(`Sending delivery receipt for log ${log._id} with status ${deliveryStatus}`);
//         axios.post(`http://localhost:${PORT}/api/delivery-receipt`, { id: log._id, status: deliveryStatus })
//           .then(response => {
//             console.log(`Delivery receipt updated for log ${log._id}:`, response.data);
//           })
//           .catch(error => {
//             console.error(`Error updating delivery receipt for log ${log._id}:`, error);
//           });
...
//   try {
//     console.log(`Updating delivery receipt for log ${id} with status ${status}`);
//     const result = await CommunicationLog.findByIdAndUpdate(id, { status }, { new: true });
//     if (!result) {
...
// });
// app.get('*', (req, res) => {
//   res.sendFile(path.join(__dirname, '../mini-crm-frontend-frontend/build', 'index.html'));
// });
// app.listen(PORT, () => {
